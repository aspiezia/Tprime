...
//BTAG SF
BTagCalibration calib("CSVv2", "SF/CSVv2_94XSF_V1_B_F.csv");
...
//Lepton SF
TFile *fileForwardJet    = new TFile("SF/ForwardJetSFFinal.root");
TFile *fileMuonTrig      = new TFile("SF/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root");
TFile *fileElectron1     = new TFile("SF/egammaEffi.txt_EGM2D_runBCDEF_passingRECO.root");
TFile *fileElectron2     = new TFile("SF/egammaEffi.txt_EGM2D_runBCDEF_passingTight94X.root");
TFile *fileElectronTrig  = new TFile("SF/ElectronTriggerSF.root");
...
TFile *fileNewPU         = new TFile("SF/PileUpReweighting2017.root");
TFile *fileNewPUUp       = new TFile("SF/PileUpReweighting2017Up.root");
TFile *fileNewPUDo       = new TFile("SF/PileUpReweighting2017Do.root");
TFile *fileZPt           = new TFile("SF/scalefactors_v4.root");
